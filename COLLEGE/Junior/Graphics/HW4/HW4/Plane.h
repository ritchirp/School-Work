...
public:
	...
	*/
	...
	Plane(const glm::vec3 & point, const glm::vec3 & normal, const Material & material, const PhongMaterial & mat);

	Plane(std::vector<glm::vec3> vertices, const Material & material, const PhongMaterial & mat);
