...
public:
	...
	*/
	...
	RayTracer(FrameBuffer & cBuffer, color defaultColor, glm::vec3 lightPoint);

	RayTracer(FrameBuffer & cBuffer, color defaultColor, PositionalLight lightSource);

	RayTracer(FrameBuffer & cBuffer, color defaultColor, float xReft, float xRight);

	RayTracer(FrameBuffer & cBuffer, color defaultColor, float xLeft);

	RayTracer(FrameBuffer & cBuffer, color defaultColor, bool isLeft);
	...
	*/
	...
	color traceIndividualRay(const glm::vec3 & e, const glm::vec3 & d, int recursionLevel, int antiAliasingLevel, int x, int y);
	...
	*/
	...
	glm::vec2 getProjectionPlaneCoordinates(const float x, const float y);
	...
	*/
	...
	int recursionDepth;
	void setAntiAliasingLevel(int l);

	void setLight(PositionalLight l);
...
protected:
	...
	*/
	...
	void setPerspectiveRayOriginAndDirection(const float x, const float y);
